...
emotion_model = Sequential()
    ...
    # CNN1
emotion_model.add(Conv2D(32, (3, 3), activation='relu', input_shape=input_shape))
emotion_model.add(MaxPooling2D(pool_size=(2, 2)))
emotion_model.add(BatchNormalization())
emotion_model.add(Dropout(0.25))

    # CNN2
emotion_model.add(Conv2D(64, (3, 3), activation='relu', padding='same'))
emotion_model.add(MaxPooling2D(pool_size=(2, 2)))
emotion_model.add(BatchNormalization())
emotion_model.add(Dropout(0.25))
...
emotion_model.load_weights('trained_facial_expression_model.h5')
...
def show_subject():
    cap1 = cv2.VideoCapture(r'V5.mp4')
...
if __name__ == '__main__':
    ...
    root.title("Data_603_Final_Project")
